...
import com.bhs.myapplication.library.SectionAdapterListUpdateCallback;
import com.bhs.myapplication.library.SectionedRecyclerViewAdapter;
import com.bhs.myapplication.R;

public class Example8Fragment extends Activity implements NameSection.ClickListener {
...
//        findViewById(R.id.fabAdd).setOnClickListener(view1 -> addNewSectionToAdapter());
